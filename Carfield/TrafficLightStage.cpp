...
#include "D:/Downloads/Carla/carla-0.9.11/LibCarla/source/carla/trafficmanager/TrafficLightStage.h"
...
void TrafficLightStage::Update(const unsigned long index) 
{
  ...
  // Handle entry negotiation at non-signalised junction.//处于非信号灯十字路口时候的四种特殊情况
